...
{
    resizeclient(c,
            selmon->wx + (selmon->mw - loww - offsetx - staylowcount * offsetoverlap),
            selmon->wy + (selmon->mh - lowh - offsety - staylowcount * offsetoverlap),
            loww,
            lowh);
    focus(c->snext);
    c->isstaylow = 1;
